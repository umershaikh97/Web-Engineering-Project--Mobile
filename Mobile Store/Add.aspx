<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Mobile_Store.Add" %>
  ...
  <a class="navbar-brand" href="Home.aspx">Mobile Store</a>
    ...
    <form id="form1" runat="server">
        ...
        <center class="homeContent">  
                ...
                <asp:Button class="btn btn-primary formWrapperAdd addBtn" ID="btnAdd" runat="server" Text="Add" OnClick="btnAdd_Click" />
            </div>
